...
export function CalculateAnalyticalReport():Promise<void>;
...
export function SaveReportFile(arg1:string):Promise<void>;
...
export function ShowSaveWordDialog():Promise<string>;
